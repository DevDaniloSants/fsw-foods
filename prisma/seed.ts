...
const createJapanese = async (
  ...
  const japaneseCategory = await prisma.category.create({
    data: {
      name: "Japonesa",
      imageUrl:
...
const createBrazilian = async (
  ...
  const brazilianCategory = await prisma.category.create({
    data: {
      name: "Brasileira",
      imageUrl:
...
const main = async () => {
  const desertsCategory = await prisma.category.create({
    data: {
      name: "Sobremesas",
      imageUrl:
  ...
  const juicesCategory = await prisma.category.create({
    data: {
      name: "Sucos",
      imageUrl:
